...
var routes = [
    ...
    {
        path: 'repos',
        loadChildren: function () { return __webpack_require__.e(/*! import() | repositories-repositories-module */ "repositories-repositories-module").then(__webpack_require__.bind(null, /*! ./repositories/repositories.module */ "./src/app/repositories/repositories.module.ts")).then(function (m) { return m.RepositoriesModule; }); }
    },
    {
        path: '',
        redirectTo: '',
...
/* harmony import */ var apollo_angular_link_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! apollo-angular-link-http */ "./node_modules/apollo-angular-link-http/fesm5/ngApolloLinkHttp.js");
